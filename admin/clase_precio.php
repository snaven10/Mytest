<?php
					class precio{
						...
						public function add_reporte_entrada($Fecha,$Cantidad,$Precio_compra,$Precio_venta,$Descuento,$Id_producto,$Estado){
							try {
								$q = $this->pdo->prepare('INSERT INTO reporte_entrada(Fecha,Cantidad,Precio_compra,Precio_venta,Descuento,Id_producto,Estado) values(?,?,?,?,?,?,?)');
