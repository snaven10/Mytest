							...
							<div class='table-responsive'>
								<table class='table table-striped table-bordered' id='tabla_datos'>
									...
									<tr>
										...
										<td><a href="#" class='btn btn-success' onclick='Buscar_r(<?php echo $row[0]; ?>)' >Mostrar</a> <a href="reporte_entradas.php?imp=<?php echo $row[0]; ?>" class='btn btn-primary'>Imprimir</a></td>
									</tr>
									<?php }?>
								</table>
							</div>
