...
<body>
<?php 
if (isset($_POST['login']) && isset($_POST['Usser']) && isset($_POST['Pass']) && isset($_POST['Tipo'])) {
    @session_start();
    include 'clases/clase_usuario.php';
    $usuario = new usuario();
        $data = $usuario->login_usuario($_POST['Usser'],md5($_POST['Pass']),$_POST['Tipo']);
        if (count($data) == 0) { ?>
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" method="POST" action="">
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input name="Usser" type="Text" class="form-control" id="inputEmail3" placeholder="Usuario" required="">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputPassword3" class="col-sm-3 control-label">Contraseña</label>
                                <div class="col-sm-9">
                                    <input name="Pass" type="password" class="form-control" id="inputPassword3" placeholder="Contraseña" required="">
                                </div>
                            </div>
                            <div class="form-group">
